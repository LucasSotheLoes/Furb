...
public class Tela extends JFrame {
	...
	public Tela() {
		...
		textFieldEndereco.setBounds(72, 34, 295, 20);
		panel.add(textFieldEndereco);
		textFieldEndereco.setColumns(10);
		
		JLabel labelEndereco = new JLabel("Endereço:");
		labelEndereco.setBounds(10, 37, 56, 14);
		...
		botaoCalcularIptu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Informe o coeficiente e area em números");
		...
		botaoIndustrial.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				imovel.setFinalidade(Finalidade.INDUSRTIAL);
				}
		});
		...
		grupo.add(botaoIndustrial);
		grupo.add(botaoComercial);
		grupo.add(botaoResidencial);
	}
}
